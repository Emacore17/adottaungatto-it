...
export default async function AccountListingDetailPage({ params }: ListingDetailPageProps) {
  ...
  await requireWebSession(`/account/annunci/${listingId}`);
  ...
  return (
    ...
    >
      <div className="space-y-4">
        <LinkButton
          className="h-10 w-fit gap-2 rounded-full px-3.5"
        ...
        <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_320px]">
          ...
          <Card>
            ...
            <CardContent className="space-y-3 text-sm text-[var(--color-text-muted)]">
              <p>
                Riferimento località: {listing.regionId}/{listing.provinceId}/{listing.comuneId}
              </p>
