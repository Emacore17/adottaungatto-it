...
export async function GET(
  ...
  if (!providerAlias) {
    return NextResponse.redirect(toLoginUrl(request, 'social_provider_unavailable', nextPath), 303);
  }

  const oidcContext = createWebOidcLoginContext(request.url, nextPath, {
