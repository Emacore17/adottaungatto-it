      ...
      <Card className="w-full">
        <CardHeader>
          <div className="mb-2 flex items-center gap-2">
            <Badge variant="outline">web login</Badge>
            <Badge variant="success">M1.3</Badge>
          </div>
          <CardTitle>Accedi a adottaungatto-it</CardTitle>
          <CardDescription>Login locale via Keycloak per area utente.</CardDescription>
        </CardHeader>
        <CardContent>
