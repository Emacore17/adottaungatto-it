...
export function PublicListingsGrid({
  ...
  const articleClassName = isFeaturedVariant
    ? 'flex h-full min-h-[430px] flex-col overflow-hidden rounded-[28px] border border-[color:color-mix(in_srgb,var(--color-border)_70%,white_30%)] bg-[color:color-mix(in_srgb,var(--color-surface-elevated)_90%,transparent)] shadow-none transition-[border-color,transform] duration-300 group-hover:border-[var(--color-border-strong)]'
