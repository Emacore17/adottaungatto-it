...
export function SiteHeader() {
  ...
  return (
    <>
      {isHome ? (
        <header className="absolute inset-x-0 top-0 z-50 px-3 pt-5 sm:px-4">
          <div className="mx-auto w-full max-w-[1180px]">
            <div className="flex items-center gap-3 rounded-2xl border border-[var(--color-border)] bg-[var(--color-header-overlay)] px-3 py-2 shadow-[var(--shadow-sm)] backdrop-blur-xl sm:px-4">
              <Link className="group inline-flex items-center gap-2" href="/">
                <span className="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-[var(--color-primary)] text-xs font-bold text-[var(--color-primary-foreground)] shadow-[var(--shadow-sm)]">
                  AG
                </span>
                <div className="min-w-0">
                  <p className="font-display text-sm font-bold leading-none text-[var(--color-text)] sm:text-base">
                    adottaungatto.it
                  </p>
        ...
        <header className="sticky top-3 z-50 px-2 sm:px-4">
          <div className="mx-auto w-full max-w-[1280px] overflow-hidden rounded-[1.6rem] border border-[var(--color-border)] bg-[var(--color-surface-overlay-strong)] shadow-[var(--shadow-lg)] backdrop-blur-md">
