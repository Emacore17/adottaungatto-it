...
const defaultServiceName = 'adottaungatto-admin';
...
export const captureAdminException = (error: unknown, source: string): void => {
...
export const capturePoorAdminWebVital = (metric: WebVitalMetric): void => {
  ...
  Sentry.captureMessage(`admin-web-vital:${metric.name}`, {
    level: 'warning',
    tags: {
      app: 'admin',
      metric: metric.name,
